...
/**
 * License validation for ETechFlow_InStorePickup.
 *
...
class LicenseValidator
{
    ...
    public const XML_PATH_ISSUED_KEY             = 'etechflow_instorepickup/license/issued_key';
    public const XML_PATH_ISSUED_AT              = 'etechflow_instorepickup/license/issued_at';
    public const XML_PATH_IP_BLOCKED             = 'etechflow_instorepickup/license/ip_blocked';
    ...
    // HMAC — per-module (UNIQUE to in-store-pickup; do not reuse elsewhere)
