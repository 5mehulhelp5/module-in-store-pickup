 ...
 * of In-Store Pickup is published to the eTechFlow private Composer repo. Fires when the
...
{
    private const PACKAGE     = 'etechflow/module-in-store-pickup';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-in-store-pickup.json';
    private const CACHE_KEY   = 'etechflow_isp_latest_version';
    private const CACHE_TTL   = 21600;
    private const LABEL       = 'In-Store Pickup';
